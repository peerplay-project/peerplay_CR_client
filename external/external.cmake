...
if (UV_LIBRARY)
    ...
    execute_process(COMMAND bash -c "git submodule update --init -- external/libuv && cd external/libuv && git fetch && git checkout v1.24.1"
...
if (UVW_LIBRARY)
    ...
    execute_process(COMMAND bash -c "git submodule update --init -- external/uvw && cd external/uvw && git fetch && git checkout v1.12.0_libuv-v1.24"
                    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR})
